...
class PostAddressDetail(models.Model):
    ...
    carrierDetails = models.CharField(max_length=20,blank = True, null = True, verbose_name='روش ارسال')
    #! 
...
class PaymentMethodeDetail(models.Model):
    ...
    PaymentDetails = models.CharField(max_length=20,blank = True, null = True, verbose_name='روش پرداخت')
